class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.6.2/xplorer-0.6.2-darwin-arm64.tar.gz"
      sha256 "6e41950cc6b5f372d79d1dd6dc4acefa01a15600cbb4207dfd9dfd791ef8ec1a"
    else
