class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.7.0/xplorer-0.7.0-darwin-arm64.tar.gz"
      sha256 "ecc4bd6232611c0e97f75eab8e05cc7c30bbfc4cdc7790ba41e137f0aa7b27e6"
    else
