class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.6.4/xplorer-0.6.4-darwin-arm64.tar.gz"
      sha256 "3738cf6a5bdae0011330c336166c0f9525834afc0dc29fb458aaff3330bb07aa"
    else
