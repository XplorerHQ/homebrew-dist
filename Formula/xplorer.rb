class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.6.3/xplorer-0.6.3-darwin-arm64.tar.gz"
      sha256 "2d9a6a5caa9150e8a8c34bd68d7797883dd05f49803c548728d1918c3bf3ac61"
    else
