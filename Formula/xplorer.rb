class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.6.6/xplorer-0.6.6-darwin-arm64.tar.gz"
      sha256 "b322addcb9315e1711e769f299479ea7131ec3e87912937fdf454823ce7117a9"
    else
