class Xplorer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/XplorerHQ/homebrew-dist/releases/download/v0.6.0/xplorer-0.6.0-darwin-arm64.tar.gz"
      sha256 "b92cf2de48a01685c9b1cd5fa42a01a5ca6aa69f61e23bcf6722be4211fa1ae0"
    else
