class XplorerCache < Formula
  include Language::Python::Virtualenv

  desc "CLI for xplorer cache"
  homepage "https://github.com/XplorerHQ/dist"
  url "https://github.com/XplorerHQ/dist/raw/main/bottle/xplorer_cache-0.1.0.tar.gz"
  sha256 "4ded33100e949e3bca5b1ff820ddf3d3b56d60e1126e17c9a1858e12139bbc81"
  version "0.1.0"
  ...
  resource "kubernetes-asyncio" do
    url "https://files.pythonhosted.org/packages/b9/74/6d454c06c44acbe2dba10aaddb87e6a8a980055308d4052aa408da280095/kubernetes_asyncio-32.3.2.tar.gz"
    sha256 "a4b6da1dbfa16e87ab8df6898f54fa03f651591a502bd6480a647d5513a580bf"
  end
  ...
  test do
    ...
    (testpath/"test.py").write <<~EOS
      ...
      print(__version__)
    EOS
    assert_match "0.1.0", shell_output("#{Formula["python@3.11"].opt_bin}/python3 #{testpath}/test.py")
  end
end
